...
document.getElementById('14').style.background = "#Ecf3f9";
document.getElementById('14').style.color = "#000";
document.getElementById('9').style.background = "#Ecf3f9";
document.getElementById('9').style.color = "#000";
document.getElementsByTagName('FOOTER')[0].style.background = "snow";
document.getElementsByTagName('FOOTER')[1].style.background = "snow";
document.getElementsByTagName('FOOTER')[1].style.background = "snow";
...
document.getElementById('ctab').style.border = "solid 2px #000";
document.getElementById('chrmsrch').style.background = "#Ecf3f9";
document.getElementById('chrmsrch').style.border = "solid 1px #343434";
document.getElementById('dbtn3').style.color = "#000";
...
document.getElementById('14').style.background = "rgb(0,0,0,0.8)";
document.getElementById('14').style.color = "#fff";
document.getElementById('9').style.background = "rgb(0,0,0,0.8)";
document.getElementById('9').style.color = "#fff";
document.getElementsByTagName('FOOTER')[0].style.background = "#000";
document.getElementsByTagName('FOOTER')[1].style.background = "#000";
document.getElementsByTagName('FOOTER')[1].style.background = "#000";
document.getElementById('10').style.background  = "#343434";
document.getElementById('10').style.color = "#fff";
document.getElementById('11').style.background  = "rgb(0,0,0,0.8)";
document.getElementById('11').style.color = "silver";
document.getElementById('ctab').style.border = "solid 2px silver";
document.getElementById('chrmsrch').style.background = "#000";
document.getElementById('dbtn3').style.color = "#fff";
document.getElementById('13').style.background  = "rgb(0,0,0,0.8)";
document.getElementById('13').style.color = "silver";
}
